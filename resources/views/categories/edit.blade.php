...
<form class="max-w-sm mx-auto" action="{{ url('categories'.$category->id) }}" method="POST" enctype="multipart/form-data">
  ...
  <div>
    ...
    <button type="submit" class="mt-5 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 border-green-900 border-solid border-2 dark:hover:bg-green-700 dark:focus:ring-green-800">Editar Categoria</button>
